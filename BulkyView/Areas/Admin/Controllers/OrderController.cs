    ...
    public class OrderController : Controller
    {
        ...
        { 
            ...
            if(orderHeader.PaymentStatus == SD.PaymentStatusApproved)
            {
                ...
                _unitOfWork.OrderHeader.UpdateStatus(orderHeader.Id, SD.StatusCacelled, SD.StatusRefunded);
            }
            else
            {
                _unitOfWork.OrderHeader.UpdateStatus(orderHeader.Id, SD.StatusCacelled, SD.StatusCacelled);
            }
